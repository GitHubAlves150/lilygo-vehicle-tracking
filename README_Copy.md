...
Até a branch feature/gps-uart a árvore do projeto está deste forma

lilygo-vehicle-tracking/
├── README.md                          ← Visão geral do projeto
├── docs/
│   ├── DOCKER-SETUP.md                ← Configuração do Docker
│   ├── GIT-WORKFLOW.md                ← Como usamos Git/GitHub
│   ├── FIRMWARE-GUIDE.md              ← Como gravar o firmware
│   └── CODE-EXPLANATION.md            ← Explicação do código
└── vehicle_tracker/
    └── main/
        └── main.cpp                   ← Código comentado
